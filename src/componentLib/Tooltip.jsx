...
function Tooltip({color,style,title="Archive notes",children,...rest}) {
    ...
    return IsShown?(
        <>
        <div {...rest} className={classNames('CompLib-Tooltip',style,color, "flexRow")}>
            <div className='icon'>
                {icon}
            </div>
            ...
            <div className='iconX' onClick={()=>setIsShown(false)}>
                {iconX}
            </div>
